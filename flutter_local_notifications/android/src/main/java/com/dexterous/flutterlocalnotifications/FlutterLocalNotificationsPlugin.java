...
public class FlutterLocalNotificationsPlugin
  ...
  protected static Notification createNotification(
    ...
    // Fix: Add these flags to prevent application restart
    // This combination ensures the Activity is brought to the top, clears
    // anything above it, and prevents its recreation.
    // ref: https://github.com/MaikuB/flutter_local_notifications/issues/2712
